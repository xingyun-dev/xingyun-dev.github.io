...
var render = function render() {
  ...
  return _c('ContentSlotsDistributor', {
    ...
    staticClass: "title"
  }), _c('p', [_vm._v("该项目是基于flask框架为后端以及bootstrap为前端框架搭建的博客项目,")])]), _vm._v(" "), _c('p', [_c('valine')], 1)]);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./docs/以flask为后端的博客项目/README.md?vue&type=template&id=2322412f
